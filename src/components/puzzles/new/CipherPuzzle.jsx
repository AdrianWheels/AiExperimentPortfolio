  ...
  return (
    <section className={`flex flex-col gap-3 h-full ${solved ? 'glow-success' : ''}`}>
      ...
      <div className="flex flex-col gap-3 flex-1">
        {/* Display */}
        <div
          className={`relative h-12 bg-black/40 rounded-lg border flex items-center justify-center overflow-hidden transition-colors ${solved
        ...
        <div className="flex items-center justify-between px-1">
          <span className="text-[10px] text-subtle sm:hidden">
            K.I.R.A. Name: <span className="text-cyan-400 font-bold font-mono tracking-wider">MK-7319</span>
          </span>
          <span className="text-[10px] text-subtle hidden sm:inline">
            Busca en <span className="text-cyan-400 font-bold tracking-wider">K.I.R.A.</span>
          </span>
