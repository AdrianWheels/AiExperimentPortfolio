  ...
  return (
    <CableBridgeProvider>
      <div className="shared-layout-container">
        <StarryBackground />
        <div className="shared-layout-inner">
          ...
          <div className="aspect-video w-full relative">
            <div className="grid grid-cols-4 grid-rows-4 gap-4 w-full h-full">
              ...
              <div className="col-start-4 row-start-1 bg-[#13131f] rounded-3xl p-4 flex items-center justify-center border border-white/5">
                <NavToggle />
              </div>
