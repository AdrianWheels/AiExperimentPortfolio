...
export default function PortfolioView() {
  ...
  const shellClass = isHacked
    ? 'relative rounded-[32px] border border-purple-700/60 bg-gradient-to-br from-purple-950/85 via-slate-950/80 to-black shadow-[0_0_40px_rgba(168,85,247,0.3)] overflow-hidden'
    : 'relative rounded-[32px] border border-slate-700/50 bg-slate-950/80 backdrop-blur-xl shadow-[0_0_36px_rgba(59,130,246,0.22)] overflow-hidden'
  ...
  return (
    <div className="w-full">
      ...
      <div className={shellClass}>
        ...
        />
        <div className={`relative z-10 px-6 pb-12 pt-10 xl:px-12 ${isHacked ? 'text-violet-100' : 'text-slate-100'}`}>
          <div className="mt-10 grid auto-rows-[minmax(240px,_1fr)] gap-6 xl:grid-cols-3">
            <PortfolioHero
